...
namespace Snork.AspNet.SignalR.Kore
{
    ...
    /// </summary>
    public class KoreMessageBus : ScaleoutMessageBus
    {
        private readonly KoreConfiguration _configuration;
        private readonly ILogger<KoreMessageBus> _logger;
        ...
        /// <returns></returns>
        public KoreMessageBus WithRepository(Func<ScaleoutConfiguration, IMessageRepository> repoFunc)
        {
        ...
        private void Initialize(object state)
        {
            ...
            {
                var stream = new KoreStream(streamIndex, _serviceProvider, _configuration, _messageRepository);
        ...
        private class LoggerListener : TraceListener
        {
            ...
            public LoggerListener(ILogger<KoreMessageBus> logger)
            {
                _logger = logger;
            }
