...
namespace Snork.AspNet.SignalR.FluentNHibernate
{
    internal static class TaskAsyncHelper
    {
        ...
        [SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes", Justification =
            "Exceptions are set in a tcs")]
        public static Task FromAsync(Func<AsyncCallback, object, IAsyncResult> beginMethod,
        ...
        [SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes", Justification =
            "Exceptions are set in a tcs")]
        public static Task<T> FromAsync<T>(Func<AsyncCallback, object, IAsyncResult> beginMethod,
            Func<IAsyncResult, T> endMethod, object state)
        {
            try
            {
                return Task.Factory.FromAsync(beginMethod, endMethod, state);
        ...
        [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode", Justification =
            "This is a shared file")]
#if SERVER
        public static TTask Catch<TTask>(this TTask task, Action<AggregateException, object> handler, object state,
            TraceSource traceSource = null) where TTask : Task
#else
        public static TTask Catch<TTask>(this TTask task, Action<AggregateException, object> handler, object state, IConnection connection
= null) where TTask : Task
#endif
        {
        ...
        [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode", Justification =
            "This is a shared file")]
#if SERVER
        private static void AttachFaultedContinuation<TTask>(TTask task, Action<AggregateException, object> handler,
            object state, TraceSource traceSource) where TTask : Task
#else
        ...
        [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode", Justification =
            "This is a shared file")]
#if SERVER
        private static void ExecuteOnFaulted(Action<AggregateException, object> handler, object state,
            AggregateException exception, TraceSource traceSource)
#else
        ...
        public static TTask Catch<TTask>(this TTask task, Action<AggregateException> handler,
            TraceSource traceSource = null) where TTask : Task
#else
        public static TTask Catch<TTask>(this TTask task, Action<AggregateException> handler, IConnection connection =
null) where TTask : Task
#endif
        {
        ...
        [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode", Justification =
            "This is a shared file")]
        public static Task<TResult> Then<T, T1, T2, TResult>(this Task<T> task, Func<T, T1, T2, TResult> successor,
            T1 arg1, T2 arg2)
        {
            switch (task.Status)
            {
            ...
            Func<Task<TResult>, T1, Task<TResult>> successor, T1 arg1)
        {
            switch (task.Status)
            {
                ...
                default:
                    return GenericDelegates<TResult, Task<TResult>, T1, object, object>
        ...
        [SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes", Justification =
            "Exceptions are flowed to the caller")]
        [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode", Justification =
            "This is a shared file")]
        ...
        public static Task Delay(TimeSpan timeOut)
        {
            ...
            return tcs.Task.ContinueWithPreservedCulture(_ => { timer.Dispose(); },
                TaskContinuationOptions.ExecuteSynchronously);
#endif
        }
        ...
        [SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes", Justification =
            "Exceptions are set in a tcs")]
        public static Task<TResult> FromMethod<T1, T2, T3, TResult>(Func<T1, T2, T3, TResult> func, T1 arg1, T2 arg2,
            T3 arg3)
        {
            try
            {
        ...
        internal static TResult RunWithPreservedCulture<T1, T2, TResult>(CulturePair preservedCulture,
        ...
        internal static TResult RunWithPreservedCulture<T, TResult>(CulturePair preservedCulture, Func<T, TResult> func,
            T arg)
        {
        ...
        {
#if NETFX_CORE || NETSTANDARD // The Thread class is not available on WinRT
            return task.ContinueWith(continuationAction, continuationOptions);
#else
            var preservedCulture = SaveCulture();
            return task.ContinueWith(t => RunWithPreservedCulture(preservedCulture, continuationAction, t),
                continuationOptions);
#endif
        }
        ...
        [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode", Justification =
            "This is a shared file")]
        internal static Task<TResult> ContinueWithPreservedCulture<T, TResult>(this Task<T> task,
            Func<Task<T>, TResult> continuationAction, TaskContinuationOptions continuationOptions)
        {
#if NETFX_CORE || NETSTANDARD // The Thread class is not available on WinRT
            return task.ContinueWith(continuationAction, continuationOptions);
#else
        ...
        [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode", Justification =
            "This is a shared file")]
        private static Task RunTaskSynchronously(Task task, Action<object> next, object state,
        ...
        private static class GenericDelegates<T, TResult, T1, T2, T3>
        {
            ...
            internal static Task<TResult> ThenWithArgs(Task<T> task, Func<T, T1, T2, TResult> successor, T1 arg1,
                T2 arg2)
            {
            ...
            internal static Task<Task> ThenWithArgs(Task task, Func<T1, T2, T3, Task> successor, T1 arg1, T2 arg2,
                T3 arg3)
            {
                return TaskRunners<object, Task>.RunTask(task, () => successor(arg1, arg2, arg3));
            }

            internal static Task<Task<TResult>> ThenWithArgs(Task<T> task, Func<T, T1, Task<TResult>> successor,
                T1 arg1)
            {
